...
// PORT is the port number where the mirror server will be deployed
#define PORT 8081

// Allowing mirror server to listen to 4 clients before
// switching back to the server
#define MAX_CLIENTS 4
// The max buffer size that needs to be stored
#define BUFFER_SIZE 1024
// Temporary tar.gz file created by the mirror server to
